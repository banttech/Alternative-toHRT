...
class CouponController extends Controller
{
    public function index()
    {
        ...
        $pageTitle = 'Alternative to HRT - Coupons';
        return view('admin.coupon.index', compact('coupons', 'pageTitle','pageTitle'));
    }

    public function create()
    {
        $pageTitle = 'Add Coupon';
        $pageTitle = 'Alternative to HRT - Add Coupon';
        return view('admin.coupon.create', compact('pageTitle','pageTitle'));
    }
    ...
    public function edit($id)
    {
        ...
        $pageTitle = 'Alternative to HRT - Edit Coupon';
        $coupon = Coupon::find($id);
        return view('admin.coupon.edit', compact('pageTitle', 'coupon','pageTitle'));
    }
