...
<div class="col-md-8">
  ...
  <div class="login-container-1">
      <div class="login-box-1">
        ...
        <form action="{{route('frontend.shipping.update')}}" method="POST" enctype="multipart/form-data">
          @if (session('error'))
        ...
        @csrf
          <div class="form-group">
            <input type="text" id="firstname"  name="firstname" required placeholder="FIRSTNAME" value="{{$shipping->firstname}}">
          </div>
          <div class="form-group">
            <input type="text" id="lastname"  name="lastname" required placeholder="LASTNAME" value="{{$shipping->lastname}}">
          </div>
          
          <div class="form-group">
            <input type="text" id="companyname"  name="companyname" required placeholder="Company name (optional)" value="{{$shipping->companyname}}">
          </div>
          ...
          <div class="form-group">
            <input type="text" id="streetaddress"  name="streetaddress" required placeholder="Street address *" value="{{$shipping->streetaddress}}">
          </div>
          <div class="form-group">
            <input type="text" id="city"  name="city" required placeholder="Town / City *" value="{{$shipping->city}}">
          </div>
          <div class="form-group">
            <input type="text" id="country"  name="country" required placeholder="County (optional)" value="{{$shipping->country}}">
          </div>
          <div class="form-group">
            <input type="text" id="postcode"  name="postcode" required placeholder="Postcode *" value="{{$shipping->postcode}}">
          </div>
