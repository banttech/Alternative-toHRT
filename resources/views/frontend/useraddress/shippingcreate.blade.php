...
<div class="col-md-8">
  ...
  <div class="login-container-1">
      <div class="login-box-1">
        ...
        <form action="{{route('frontend.shipping.store')}}" method="POST" enctype="multipart/form-data">
          @if (session('error'))
        ...
        @csrf
          ...
          <div class="form-group">
            <input type="text" id="streetaddress"  name="streetaddress" required placeholder="Street address *">
          </div>
          <div class="form-group">
            <input type="text" id="city"  name="city" required placeholder="Town / City *">
          </div>
          <div class="form-group">
            <input type="text" id="country"  name="country" placeholder="County (optional)">
          </div>
          <div class="form-group">
