  ...
  <div class="conatiner-fluid about-inner">
    <div class="row about-row">
      <div class="about-heading">
        ...
        @else --}}
        <h6>{{ucwords($category->categoryname)}}</h6>
        {{-- @endif --}}
      </div>
    </div>
  </div>
...
<section class="card-sec-shop">
      ...
      <div class="col-md-3">
        <div class="side-bar-sec">
          ...
          <ul>
            ...
            @php
            $products = DB::table('product')->where('product_category_id',$productCategory->id)->where('status','Active')->get();
  ...
  $products = DB::table('product')->orderBy('id', 'asc')->where('product_category_id', $category->id)->where('status','Active')->take(4)->get();
