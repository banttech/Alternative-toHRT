...
<html lang="en">
    ...
    border: 1px solid #ccc;">
	       ...
	       <tr><td colspan="2" style="padding-bottom:0">
	       	<a href="{{ url('reset-password/'.$token) }}" style="text-decoration:none;width:250px;background:green;padding:15px;display:block;color:#fff;font-weight:700;border-radius:10px;text-align:center;margin:0 auto">Reset Password</a>
	       </td></tr>
		...
		<tr>
			<td colspan="2" style="padding:0px 15px 15px;">alternativetoHRT
</td>
		</tr>
		<tr>
			<td>
