      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{route('admin.test')}}" class="app-brand-link">
             
              <span class="app-brand-text demo menu-text fw-bolder ms-2"><img src="{{ asset('admin_assets/images/logo.webp')}}" alt="" width="65px" height="65px"></span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="{{route('admin.test')}}" class="menu-link">
           ...
           <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="{{route('user')}}" class="menu-link">
                    <div data-i18n="Basic Inputs">User List</div>
                  </a>
                </li>
                </ul>
            </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('productcategory')}}" class="menu-link">
                    <div data-i18n="Input groups">Product Category</div>
                  </a>
                </li>

                <li class="menu-item">
                  <a href="{{route('brand')}}" class="menu-link">
                    <div data-i18n="Input groups">Brands</div>
                  </a>
                </li>

                <li class="menu-item">
                  <a href="{{route('product')}}" class="menu-link">
                    <div data-i18n="Input groups">Products</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('wellness_blog')}}" class="menu-link">
                    <div data-i18n="Input groups">Wellness Blogs</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{route('blogcategory')}}" class="menu-link">
                    <div data-i18n="Input groups">Blog Category</div>
                  </a>
                </li>
                  <li class="menu-item">
                  <a href="{{route('comment')}}" class="menu-link">
                    <div data-i18n="Input groups">Blog Comments</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="{{route('success_stories')}}" class="menu-link">
            ...
            <li class="menu-item">
              <a href="{{route('country')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Input groups">Countries</div>
              </a>
            </li>
           ...
           ?>
            <li class="menu-item">
              <a href="{{route('privacy-policy.edit',$privacy_policys->id)}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Input groups">Privacy Policy</div>
              </a>
            </li>
           ...
           ?>
            ...
            <li class="menu-item">
              <a href="{{route('terms-conditions.edit',$terms->id)}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Input groups">Terms and Conditions</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="{{route('contact')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Input groups">Contact</div>
              </a>
            </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{ url('admin_assets/images/'. Auth::user()->image)}}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">{{ucfirst(Auth::user()->firstname. ' '. Auth::user()->lastname)}}</span>
