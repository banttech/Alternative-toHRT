        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form action="{{ route('coupon.store') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="basic-default-name">Usage Allowed</label>
                <div class="col-sm-10">
              ...
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="basic-default-name">Discount (In %)*</label>
                <div class="col-sm-10">
              ...
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="basic-default-name">Valid From*</label>
                <div class="col-sm-10">
              ...
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="basic-default-name">Valid To*</label>
                <div class="col-sm-10">
