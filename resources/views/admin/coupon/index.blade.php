  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    {{-- <form action="{{route('product')}}" method="GET">
      <div class="input-group mb-3">
        <input type="text" class="form-control" placeholder="Serch by name and description" name="search"
    ...
    <div class="card">
      ...
      <div class="d-flex justify-content-end mb-2">
        <a href="{{ route('coupon.create') }}" class="btn btn-primary admin_allpage">Add Coupon</a>
      </div>
