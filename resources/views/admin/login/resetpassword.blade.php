        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="text-center font-weight-bold"><img src="{{ asset('admin_assets/images/logo.webp')}}" alt="" width="80px" height="80px">
              </h4>
              <p class="text-center">Account Reset</p>
              <form id="formAuthentication" class="mb-3" action="{{ url('admin/resets-password/'.$token) }}" method="POST">
              ...
              @endif 
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-20" type="submit">Submit</button>
                </div>
              </form>
