        ...
        <div class="card-body">
          <form action="{{route('brand.update',$brands->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="brandname" id="basic-default-name" value="{{$brands->brandname}}" placeholder="" >
              </div>
              @error('brandname')
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="slug" id="basic-default-name" value="{{$brands->slug}}" placeholder="" required >
              </div>
              @error('brandname')
              <div class="text-danger offset-sm-2 col-sm-10">{{ $message }}</div>
               @enderror
