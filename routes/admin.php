...
Route::group(['prefix' => 'admin','middleware' => ['auth','admin']], function () {
    ...
    Route::get('add/success-stories', [SuccessStoriesController::class, 'create'])->name('success_stories.create');
    Route::post('add/success-stories', [SuccessStoriesController::class, 'store'])->name('success_stories.store');
    Route::get('/success-stories/edit/{id}', [SuccessStoriesController::class, 'edit'])->name('success_stories.edit');
    Route::post('/success-stories/update/{id}', [SuccessStoriesController::class, 'update'])->name('success_stories.update');
    Route::get('/success-stories/delete/{id}', [SuccessStoriesController::class, 'delete'])->name('success_stories.delete');
...
// for blog category
  ...
  Route::get('blog-category', [BlogCategoryController::class, 'index'])->name('blogcategory');
  Route::get('add/blog-category', [BlogCategoryController::class, 'create'])->name('blogcategory.create');
  Route::post('add/blo-gcategory', [BlogCategoryController::class, 'store'])->name('blogcategory.store');
  Route::get('/blog-category/edit/{id}', [BlogCategoryController::class, 'edit'])->name('blogcategory.edit');
  Route::post('/blog-category/update/{id}', [BlogCategoryController::class, 'update'])->name('blogcategory.update');
  Route::get('/blog-category/delete/{id}', [BlogCategoryController::class, 'delete'])->name('blogcategory.delete');

// for Product category

Route::get('product-category', [ProductCategoryController::class, 'index'])->name('productcategory');
Route::get('add/product-category', [ProductCategoryController::class, 'create'])->name('productcategory.create');
Route::post('add/product-category', [ProductCategoryController::class, 'store'])->name('productcategory.store');
...
Route::get('/product-category/delete/{id}', [ProductCategoryController::class, 'delete'])->name('productcategory.delete');
